...
public class SeparationController {
    ...
    public ApiResponse<PaymentResponse> updatePayment(
        ...
        return ApiResponse.ok("Abono actualizado", separationService.updatePayment(id, paymentId, request, currentUser));
    }
    ...
    public ApiResponse<Void> deletePayment(
        ...
        separationService.deletePayment(id, paymentId, currentUser);
